...
<form id="wb3_modal_form" class="wb3_modal_form">
    <div class="row">
        <?php foreach ($this->currentScheme->schemeFields as $field) { ?>
            ...
            <?php $fieldData[$field->wb3_field] = ($this->sysVars['wb3_key'] == $field->wb3_field) ? $this->sysVars['wb3_val'] : null; ?>
            <div class="col-12"> <?php echo InputHelper::makeInput($field, $fieldData, 'add'); ?></div>
        <?php } ?>
    </div>
    <div class="row">
        <div class="col-12">
            <span class="btn btn-sm btn-success wb3_modalbtn" id="wb3_save_exec_btn"><?php echo JText::_('COM_WEBBASE_BTN_ADD'); ?></span>
