    ...
    public function display($tpl = null)
    {
        ...
        if ($this->schemeRights['wb3_r'] == 1) {
            ...
            if ($this->sysVars['wb3_search_clear'] == 1) {
                SysHelper::clearDefaults('wb3_search' . '_' . $this->sysVars['wb3_scheme']);
                SysHelper::clearDefaults('wb3_search_field' . '_' . $this->sysVars['wb3_scheme']);
            }
            ...
            SysHelper::setDefaults('wb3_search' . '_' . $this->sysVars['wb3_scheme'], $this->sysVars['wb3_search']);
            SysHelper::setDefaults('wb3_search_field' . '_' . $this->sysVars['wb3_scheme'], $this->sysVars['wb3_search_field']);
            ...
            $this->wb3Search = SysHelper::getDefaults('wb3_search' . '_' . $this->sysVars['wb3_scheme']);
            $this->wb3SearchField = SysHelper::getDefaults('wb3_search_field' . '_' . $this->sysVars['wb3_scheme']);
